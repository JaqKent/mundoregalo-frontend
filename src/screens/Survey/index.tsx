                ...
                <form className={styles.formContainer}>
                    <div className={styles.topSection}>
                        <div className={styles.title}>
                            <h2>
                                Por favor califique la calidad de nuestro
                                servicio en una escala del 1-5.
                            </h2>
                        </div>
                        ...
                        <div className={styles.inputRadio}>
                            {SURVEY2.map((form) => (
                                <CustomInput
                                    ...
                                    value={form.value}
                                    onChange={() =>
                                        setCurrentRadioStatus(form.value)
                                    }
                                    type={form.type}
                                />
                            ))}
