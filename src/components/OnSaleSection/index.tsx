...
function OnSaleSection() {
  ...
  const handleView = () => { setViewMore((prevState) => !prevState); };
  const slicedData = data.slice(0, viewMore ? 8 : 4);
  const handleOfert = () => { navigate('/'); };
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.button} role="button" tabIndex={0} onClick={viewMore ? handleOfert : handleView}>
        {viewMore
